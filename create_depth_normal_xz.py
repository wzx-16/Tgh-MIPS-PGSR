...
def render_set(model_path, name, iteration, views, gaussians, tgh, pipeline, background):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        print(os.path.join(predicted_normal_path, viewpoint_cam.image_path[-15:-4] + ".npy"))
        np.save(os.path.join(predicted_depth_path, viewpoint_cam.image_path[-15:-4] + ".npy"), predicted_depth)
        np.save(os.path.join(predicted_normal_path, viewpoint_cam.image_path[-15:-4] + ".npy"), predicted_normal)
