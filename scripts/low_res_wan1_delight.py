...
if __name__ == '__main__':
    ...
    images = [f[len(args.path):] for f in sorted(glob.glob(os.path.join(args.path, "images_delight_origin/", "*"))) if f.lower().endswith('png') or f.lower().endswith('jpg') or f.lower().endswith('jpeg')]
    ...
    for imagename in images:
        ...
        print(os.path.join(os.path.join(args.path, "images_delight"), imagename[22:]))
        cv2.imwrite(os.path.join(os.path.join(args.path, "images_delight"), imagename[22:]), undis_img)
