...
def load_calib_and_compute_demo_intrinsics(calib_path):
    ...
    for item in calib["calibrations"]:
        ...
        new_camera_matrix[0, 2] -= 348
        new_camera_matrix[1, 2] -= 336

        W2 = W - 696
        H2 = H - 672

        # demo scales by /2
        new_camera_matrix[0, 0] /= 2.0
        new_camera_matrix[1, 1] /= 2.0
        new_camera_matrix[0, 2] /= 2.0
        new_camera_matrix[1, 2] /= 2.0
        W2 = W2 // 2
        H2 = H2 // 2
        # ==========================================
